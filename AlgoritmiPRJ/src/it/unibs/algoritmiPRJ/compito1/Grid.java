 ...
 * verificare la attraversabile delle celle e gestire gli ostacoli.
 */
public interface Grid {
    ...
    /**
     * Restituisce true se la cella è attraversabile, false altrimenti.
    ...
    /**
	 * Restituisce true se la cella specificata da riga e colonna è attraversabile, false altrimenti.
    ...
    /**
     * Restituisce un elenco di celle attraversabile nella griglia.
     * @return Un elenco di celle attraversabile nella griglia.
     */
     ...
     * @param cell La cella da verificare.
     * @return true se la cella è valida (cioè all'interno della griglia e attraversabile), false altrimenti.
     */
